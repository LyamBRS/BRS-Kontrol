...
LoadingLog.Start("BluetoothMenu.py")
#====================================================================#
# Imports
#====================================================================#
#region ------------------------------------------------------ Python
...
# Screen class
#====================================================================#
LoadingLog.Class("BluetoothMenu_Screens")
class BluetoothMenu_Screens:
    """
        BluetoothMenu_Screens:
        ================
        Summary:
        --------
        ...
        Description:
        ------------
        This class holds the different types of callers of the BluetoothMenu
    ...
    def SetExiter(screenClass, screenName:str, transition=SlideTransition, duration:float=0, direction:str="up") -> bool:
        ...
        BluetoothMenu_Screens._exitClass = screenClass
        BluetoothMenu_Screens._exitName  = screenName

        BluetoothMenu_Screens._exitTransition = transition
        BluetoothMenu_Screens._exitDuration = duration
        BluetoothMenu_Screens._exitDirection = direction
        return False
    ...
    def SetCaller(screenClass, screenName:str, transition=SlideTransition, duration:float=0, direction:str="up") -> bool:
        ...
        """
        # Attempt to add the screen class as a widget of the AppManager
        BluetoothMenu_Screens._callerClass = screenClass
        BluetoothMenu_Screens._callerName  = screenName

        BluetoothMenu_Screens._callerTransition = transition
        BluetoothMenu_Screens._callerDuration = duration
        BluetoothMenu_Screens._callerDirection = direction
        return False
    ...
    def _Exit() -> bool:
        ...
        try:
            ...
            try:
                ...
                BluetoothMenu_Screens._exitClass.Call()
                Debug.Log("Success")
                Debug.End()
                return False
            except:
                Debug.Log("Class specified wasn't an _Screen class.")
                AppManager.manager.add_widget(BluetoothMenu_Screens._exitClass(name=BluetoothMenu_Screens._exitName))
        except:
            Debug.Error("BluetoothMenu_Screens -> Exception occured.")
            Debug.End()
            return True

        # Attempt to call the added screen
        AppManager.manager.transition = BluetoothMenu_Screens._exitTransition()
        AppManager.manager.transition.duration = BluetoothMenu_Screens._exitDuration
        AppManager.manager.transition.direction = BluetoothMenu_Screens._exitDirection

        # try:
        AppManager.manager.current = BluetoothMenu_Screens._exitName
        # except:
            # return True
        Debug.End()
        return False
    ...
    def Call() -> bool:
        ...
        try:
            ...
            AppManager.manager.add_widget(BluetoothMenu(name="BluetoothMenu"))
        except:
        ...
        # Attempt to call the added screen
        AppManager.manager.transition = BluetoothMenu_Screens._callerTransition()
        AppManager.manager.transition.duration = BluetoothMenu_Screens._callerDuration
        AppManager.manager.transition.direction = BluetoothMenu_Screens._callerDirection

        # try:
        AppManager.manager.current = "BluetoothMenu"
...
# Classes
#====================================================================#
LoadingLog.Class("BluetoothMenu")
class BluetoothMenu(Screen):
    ...
    def __init__(self, **kwargs):
        ...
        Debug.Start("BluetoothMenu -> __init__")
        Debug.End()
        #endregion
# ------------------------------------------------------------------------
    def on_pre_enter(self, *args):
        """
        """
        Debug.Start("BluetoothMenu -> on_pre_enter")
        ...
        #endregion
        #region ---------------------------- ToolBar
        self.ToolBar = AppNavigationBar(pageTitle=_("Bluetooth Parameters"))
        #endregion
...
# ------------------------------------------------------------------------
    def on_enter(self, *args):
        ...
        """
        Debug.Start("BluetoothMenu -> on_enter")
        Debug.End()
# ------------------------------------------------------------------------
    def on_pre_leave(self, *args):
        ...
        """
        Debug.Start("BluetoothMenu -> on_pre_leave")
        Debug.End()
# ------------------------------------------------------------------------
    def on_leave(self, *args):
        ...
        """
        Debug.Start("BluetoothMenu -> on_leave")
...
LoadingLog.End("BluetoothMenu.py")