...
LoadingLog.Start("DebuggerBrSpand.py")
#====================================================================#
# Imports
#====================================================================#
#region ------------------------------------------------------ Python
...
from Local.Drivers.Debugger.Programs.GUI.Navigation import DebugNavigationBar
...
# Screen class
#====================================================================#
LoadingLog.Class("DebuggerBrSpand_Screens")
class DebuggerBrSpand_Screens:
    """
        DebuggerBrSpand_Screens:
        ================
        Summary:
        --------
        This class allows the handling of the transitional screen
        :class:`DebuggerBrSpand`.

        Description:
        ------------
        This class holds the different types of callers of the DebuggerBrSpand
    ...
    def SetExiter(screenClass, screenName:str, transition=SlideTransition, duration:float=0, direction:str="up") -> bool:
        ...
        DebuggerBrSpand_Screens._exitClass = screenClass
        DebuggerBrSpand_Screens._exitName  = screenName

        DebuggerBrSpand_Screens._exitTransition = transition
        DebuggerBrSpand_Screens._exitDuration = duration
        DebuggerBrSpand_Screens._exitDirection = direction
        return False
    ...
    def SetCaller(screenClass, screenName:str, transition=SlideTransition, duration:float=0, direction:str="up") -> bool:
        ...
        """
        # Attempt to add the screen class as a widget of the AppManager
        DebuggerBrSpand_Screens._callerClass = screenClass
        DebuggerBrSpand_Screens._callerName  = screenName

        DebuggerBrSpand_Screens._callerTransition = transition
        DebuggerBrSpand_Screens._callerDuration = duration
        DebuggerBrSpand_Screens._callerDirection = direction
        return False
    ...
    def _Exit() -> bool:
        ...
        try:
            ...
            try:
                ...
                DebuggerBrSpand_Screens._exitClass.Call()
                Debug.Log("Success")
                Debug.End()
                return False
            except:
                Debug.Log("Class specified wasn't an _Screen class.")
                AppManager.manager.add_widget(DebuggerBrSpand_Screens._exitClass(name=DebuggerBrSpand_Screens._exitName))
        except:
            Debug.Error("DebuggerBrSpand_Screens -> Exception occured.")
            Debug.End()
            return True

        # Attempt to call the added screen
        AppManager.manager.transition = DebuggerBrSpand_Screens._exitTransition()
        AppManager.manager.transition.duration = DebuggerBrSpand_Screens._exitDuration
        AppManager.manager.transition.direction = DebuggerBrSpand_Screens._exitDirection

        # try:
        AppManager.manager.current = DebuggerBrSpand_Screens._exitName
        # except:
            # return True
        Debug.End()
        return False
    ...
    def Call() -> bool:
        ...
        try:
            ...
            AppManager.manager.add_widget(DebuggerBrSpand(name="DebuggerBrSpand"))
        except:
        ...
        # Attempt to call the added screen
        AppManager.manager.transition = DebuggerBrSpand_Screens._callerTransition()
        AppManager.manager.transition.duration = DebuggerBrSpand_Screens._callerDuration
        AppManager.manager.transition.direction = DebuggerBrSpand_Screens._callerDirection

        # try:
        AppManager.manager.current = "DebuggerBrSpand"
...
# Classes
#====================================================================#
LoadingLog.Class("DebuggerBrSpand")
class DebuggerBrSpand(Screen):
    """
        DebuggerBrSpand:
        -----------
    ...
    def __init__(self, **kwargs):
        ...
        Debug.Start("DebuggerBrSpand -> __init__")
        Debug.End()
        #endregion
# ------------------------------------------------------------------------
    def on_pre_enter(self, *args):
        """
        """
        Debug.Start("DebuggerBrSpand -> on_pre_enter")
        ...
        #endregion
        #region ---------------------------- ToolBar
        self.ToolBar = DebugNavigationBar(pageTitle=_("BrSpand Debugger"))
        #endregion
...
# ------------------------------------------------------------------------
    def on_enter(self, *args):
        ...
        """
        Debug.Start("DebuggerBrSpand -> on_enter")
        Debug.End()
# ------------------------------------------------------------------------
    def on_pre_leave(self, *args):
        ...
        """
        Debug.Start("DebuggerBrSpand -> on_pre_leave")
        Debug.End()
# ------------------------------------------------------------------------
    def on_leave(self, *args):
        ...
        """
        Debug.Start("DebuggerBrSpand -> on_leave")
...
LoadingLog.End("DebuggerBrSpand.py")