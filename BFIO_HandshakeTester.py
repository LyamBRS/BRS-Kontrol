...
def PrintBFIODriver():
    ...
    print(f"Left joystick Y:         {BFIODriver._realLeftJoystickY()}")
    print(f"Left joystick button:    {BFIODriver._realLeftJoystickButton()}")
    print("-------------------------------------")
    print(f"Right joystick X:        {BFIODriver._realRightJoystickX()}")
    print(f"Right joystick Y:        {BFIODriver._realRightJoystickY()}")
    print(f"Right joystick button:   {BFIODriver._realRightJoystickButton()}")
    print("-------------------------------------")
    print(f"Switch 1: {BFIODriver._realSwitch1}")
    print(f"Switch 2: {BFIODriver._realSwitch2}")
    print(f"Switch 3: {BFIODriver._realSwitch3}")
    print(f"Switch 4: {BFIODriver._realSwitch4}")
    print(f"Switch 5: {BFIODriver._realSwitch5}")

def SleepAndPrintHeader(timeSlept, maxTime):
    time.sleep(1)
    pourcent = int((1-(timeSlept/maxTime))*100)
    print(f"=========================================== [{pourcent}%]")
