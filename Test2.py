...
print("######################################################")
RGB.SetAttributes(colors=[[50,50,50], [0,0,0], [0,0,0]], mode = RGBModes.pulse)
time.sleep(3)
...
print("######################################################")
RGB.SetAttributes(colors=[[50,0,0], [0,50,0], [0,0,50]], mode = RGBModes.cycling)
time.sleep(5)

print("\n######################################################")
print("TESTING: 5s: Loading, B=(50,0,50), R=(50,50,0), S=(0,50,50)")
print("######################################################")
RGB.SetAttributes(colors=[[50,0,50], [50,50,0], [0,50,50]], mode = RGBModes.loading)
time.sleep(5)
