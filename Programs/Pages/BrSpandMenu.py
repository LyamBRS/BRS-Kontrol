...
LoadingLog.Start("BrSpandMenu.py")
#====================================================================#
# Imports
#====================================================================#
#region ------------------------------------------------------ Python
...
# Screen class
#====================================================================#
LoadingLog.Class("BrSpandMenu_Screens")
class BrSpandMenu_Screens:
    """
        BrSpandMenu_Screens:
        ================
        Summary:
        ...
        Description:
        ------------
        This class holds the different types of callers of the BrSpandMenu
    ...
    def SetExiter(screenClass, screenName:str, transition=SlideTransition, duration:float=0, direction:str="up") -> bool:
        ...
        BrSpandMenu_Screens._exitClass = screenClass
        BrSpandMenu_Screens._exitName  = screenName

        BrSpandMenu_Screens._exitTransition = transition
        BrSpandMenu_Screens._exitDuration = duration
        BrSpandMenu_Screens._exitDirection = direction
        return False
    ...
    def SetCaller(screenClass, screenName:str, transition=SlideTransition, duration:float=0, direction:str="up") -> bool:
        ...
        """
        # Attempt to add the screen class as a widget of the AppManager
        BrSpandMenu_Screens._callerClass = screenClass
        BrSpandMenu_Screens._callerName  = screenName

        BrSpandMenu_Screens._callerTransition = transition
        BrSpandMenu_Screens._callerDuration = duration
        BrSpandMenu_Screens._callerDirection = direction
        return False
    ...
    def _Exit() -> bool:
        ...
        try:
            ...
            try:
                ...
                BrSpandMenu_Screens._exitClass.Call()
                Debug.Log("Success")
                Debug.End()
                return False
            except:
                Debug.Log("Class specified wasn't an _Screen class.")
                AppManager.manager.add_widget(BrSpandMenu_Screens._exitClass(name=BrSpandMenu_Screens._exitName))
        except:
            Debug.Error("BrSpandMenu_Screens -> Exception occured.")
            Debug.End()
            return True

        # Attempt to call the added screen
        AppManager.manager.transition = BrSpandMenu_Screens._exitTransition()
        AppManager.manager.transition.duration = BrSpandMenu_Screens._exitDuration
        AppManager.manager.transition.direction = BrSpandMenu_Screens._exitDirection

        # try:
        AppManager.manager.current = BrSpandMenu_Screens._exitName
        # except:
            # return True
        Debug.End()
        return False
    ...
    def Call() -> bool:
        ...
        try:
            ...
            AppManager.manager.add_widget(BrSpandMenu(name="BrSpandMenu"))
        except:
        ...
        # Attempt to call the added screen
        AppManager.manager.transition = BrSpandMenu_Screens._callerTransition()
        AppManager.manager.transition.duration = BrSpandMenu_Screens._callerDuration
        AppManager.manager.transition.direction = BrSpandMenu_Screens._callerDirection

        # try:
        AppManager.manager.current = "BrSpandMenu"
...
# Classes
#====================================================================#
LoadingLog.Class("BrSpandMenu")
class BrSpandMenu(Screen):
    """
        BrSpandMenu:
        -----------
    ...
    def __init__(self, **kwargs):
        ...
        Debug.Start("BrSpandMenu -> __init__")
        Debug.End()
        #endregion
# ------------------------------------------------------------------------
    def on_pre_enter(self, *args):
        ...
        #endregion
        #region ---------------------------- ToolBar
        self.ToolBar = AppNavigationBar(pageTitle=_("BrSpand Parameters"))
        #endregion
...
# ------------------------------------------------------------------------
    def on_pre_leave(self, *args):
        ...
        """
        Debug.Start("BrSpandMenu -> on_pre_leave")
        Debug.End()
# ------------------------------------------------------------------------
    def on_leave(self, *args):
        ...
        """
        Debug.Start("BrSpandMenu -> on_leave")
